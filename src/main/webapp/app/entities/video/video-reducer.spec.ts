...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './video.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VIDEO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VIDEO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VIDEO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VIDEO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VIDEO actions', async () => {
      const arg = 42666;
