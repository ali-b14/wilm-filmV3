...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOMETADATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VIDEOMETADATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VIDEOMETADATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VIDEOMETADATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOMETADATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VIDEOMETADATA actions', async () => {
      const arg = 42666;
