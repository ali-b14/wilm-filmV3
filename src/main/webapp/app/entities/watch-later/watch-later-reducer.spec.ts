...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WATCHLATER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WATCHLATER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WATCHLATER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WATCHLATER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WATCHLATER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WATCHLATER actions', async () => {
      const arg = 42666;
