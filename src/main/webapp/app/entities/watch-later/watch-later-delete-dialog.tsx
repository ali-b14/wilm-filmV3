...
export const WatchLaterDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="wilmFilmApp.watchLater.delete.question">
        <Translate contentKey="wilmFilmApp.watchLater.delete.question" interpolate={{ id: watchLaterEntity.id }}>
          Are you sure you want to delete this WatchLater?
        </Translate>
      </ModalBody>
      <ModalFooter>
