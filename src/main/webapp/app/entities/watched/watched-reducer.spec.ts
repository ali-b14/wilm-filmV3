...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './watched.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WATCHED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WATCHED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WATCHED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WATCHED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WATCHED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WATCHED actions', async () => {
      const arg = 42666;
